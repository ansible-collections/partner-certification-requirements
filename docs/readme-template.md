...
- Use the following text, removing the backticks and replacing `<product team name>` with the appropriate team:
...
to support through Ansible Automation Platform (AAP) using the
